...
#   - Выходные файлы анализа сохраняются рядом с исходными в той же директории
#
# =============================================================================
...
# Рабочая директория, где будут создаваться вспомогательные скрипты
SCRIPT_DIR="/cefs/higgs/kositsin/CEPCSW-tutorial/Analysis/myAnalysis/scripts"

# Путь к установленному CEPCSW (там находится run.sh и setup.sh)
CEPCSW_ROOT="/cefs/higgs/kositsin/CEPCSW-tutorial"

# Название процесса (используется в именах файлов)
...
if [ "$SUBMIT_JOBS" -eq 1 ]; then
    ...
    echo "Логи будут в: ${JOB_DIR}/*.out и *.err"
else
